...
/*
        ...
        File myDir = new File(afilpath+"/UDIRECT");
        myDir.mkdirs();
*/
        File mediaStorageDir = new File(Environment.getExternalStorageDirectory(), "UDIRECT");
...
//        File saveFolder = new File(Environment.getExternalStorageDirectory(), "Stories/" + getTimestamp());
        ...
        /*File saveFolder = new File( Environment.getExternalStorageDirectory(),"UDIRECT");
        try{
            if (!saveFolder.mkdirs());
        }catch (RuntimeException e){
            e.printStackTrace();
            ...
            if (resultCode == RESULT_OK) {
             ...
             //  Toast.makeText(this, "Saved to: " + data.getDataString(), Toast.LENGTH_LONG).show();
              ...
              //  Toast.makeText(this, "GOT YOU", Toast.LENGTH_LONG).show();
                ...
                String destinationFilename = android.os.Environment.getExternalStorageDirectory().getPath()+"/UDIRECT/v1.mp4";
