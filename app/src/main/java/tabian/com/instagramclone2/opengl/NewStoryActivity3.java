...
public class NewStoryActivity3 extends Activity {
...
//                .autoRecordWithDelayMs(5000)                       // Same as the above, expressed with milliseconds instead of seconds.
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_RQ) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                String destinationFilename = android.os.Environment.getExternalStorageDirectory().getPath() + "/UDIRECT/v3.mp4";
            ...
            Intent intent = new Intent(NewStoryActivity3.this, NewStoryActivity3next.class);
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(this,NewStoryActivity3.class);
        startActivity(intent);
    }
}
