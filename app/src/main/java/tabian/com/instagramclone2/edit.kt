...
class edit : Activity(), PermissionRequest.Response {
        ...
        setContentView(R.layout.activity_main1)
         ...
         val sharebut = findViewById<Button>(R.id.share)
            sharebut.setOnClickListener{
                val intent = Intent1(this,tabian.com.instagramclone2.Share.NextActivity::class.java)
    ...
    override fun onBackPressed() {
        val intent = Intent1(this,tabian.com.instagramclone2.Home.HomeActivity::class.java)
        startActivity(intent)
    }
}